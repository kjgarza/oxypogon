# CrossFit MINS Workout - 2026-08-23
...
Hey everyone! Today’s WOD is all about quality movement and building endurance through a series of rounds. We’ll be doing 6 rounds of rowing or skiing, followed by some box step-ups, kettlebell sumo deadlift high pulls, and ring rows. The goal here is to maintain good form throughout each movement while keeping a steady pace. This workout is designed to challenge your cardiovascular fitness, lower body strength, and upper body pulling power. Let’s break it down!
...
- **Technique Steps:**
    ...
    - Start with your knees bent and your back straight. Engage your core.
    ...
    - For the Ski Erg, stand tall and grip the handles. Use your legs to initiate the pull, driving your arms down and back, then return to the starting position.
...
- **Technique Steps:**
    ...
    - Step up onto the box with one foot, pushing through your heel to lift your body.
...
- **Form Tips:**
    ...
    - Alternate the leading foot for balance.
...
- **Form Tips:**
    ...
    - Avoid using your arms too much; focus on the hip drive.

- **Scaling/Modifications:**
    - Use a lighter kettlebell if you’re new to this movement.
    - If kettlebells are unavailable, you can substitute with dumbbell high pulls or bodyweight squats.
...
- **Form Tips:**
    ...
    - Maintain a steady pace throughout the reps.
...
- Break up the movements into manageable sets if needed, especially the kettlebell high pulls and ring rows.
- Stay hydrated and take short breaks between rounds if necessary, but keep them brief to maintain your heart rate.

Alright, team! Let’s get after it and focus on quality movement today. Remember, it’s not just about finishing; it’s about how well you perform each rep. Let’s have some fun!

---
*Generated on 2026-08-23T06:10:34.776Z using AI assistance*
