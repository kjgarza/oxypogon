# CrossFit MINS Workout - 2026-06-26
...
Hey everyone! Today’s WOD is all about quality and maintaining good movement patterns while getting in some solid work. We’ll be doing 6 rounds of a mix of cardio, strength, and bodyweight movements. The goal here is to focus on your form and technique rather than just rushing through the reps. This will help build endurance, strength, and overall fitness. Let’s break it down step by step!
...
- **Ski Erg**: Stand tall, grip the handles, and initiate the movement by pulling down with your arms while engaging your core and legs. 
...
- If you’re new to rowing, consider reducing the intensity or using a lower damper setting.
- For Ski Erg, you can perform the movement seated if standing is challenging.
...
- Ensure your elbows stay high and outside as you pull the kettlebell.

#### Scaling/Modifications:
- Use a lighter kettlebell if you’re new to this movement.
- You can also perform the movement without the kettlebell, focusing on the hinge and pull motion.
...
- Grip the rings and lean back, keeping your body straight from head to heels.
- Pull your chest towards the rings by bending your elbows and squeezing your shoulder blades together.

#### Form Tips:
- Keep your body straight; avoid sagging hips or arching your back.
...
- **Sweat**: 
  ...
  - Box Step-ups: 16” box for women, 8” for men.
  - Kettlebell: 8kg/4kg.
  - Ring Rows: Bodyweight.

- **Train**: 
  - Row/Ski: Steady pace, aim for consistent strokes.
  - Box Step-ups: 20” box for women, 12” for men.
  - Kettlebell: 12kg/6kg.
  - Ring Rows: Bodyweight or with a slight incline.

- **Compete**: 
  - Row/Ski: Push for max effort.
  - Box Step-ups: 24” box for women, 16” for men.
  - Kettlebell: 16kg/12kg.
  - Ring Rows: Bodyweight, focus on speed.

### Strategy Advice:
- Focus on quality over quantity. Take your time with each movement to ensure you’re using proper form.
- Break up the reps if needed, especially on the kettlebell and ring rows, to maintain good technique.
- Stay consistent with your pacing on the row or ski; it’s better to maintain a steady rhythm than to sprint and burn out.
...
---
*Generated on 2026-06-26T07:24:52.218Z using AI assistance*
